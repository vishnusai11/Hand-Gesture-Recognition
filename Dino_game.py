...
import numpy as np
import math
import pyautogui as pag #used for contolling mouse and keyboard without user intervention
...
while cam.isOpened():
  ...
  #used the 2 finger/'peace' sign as the gesture to make the dino jump
  if count_defects == 1:
    pag.press('space')
    cv.putText(img, "Jump", (50, 50), cv.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 255)) 
